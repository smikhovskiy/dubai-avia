...
- **Аэропорты ОАЭ (приоритет по убыванию):** DXB → AUH → DWC. Штраф растёт с понижением приоритета.
- **Аэропорты Москвы (приоритет по убыванию):** SVO → VKO → DME. Аналогичный штраф.
